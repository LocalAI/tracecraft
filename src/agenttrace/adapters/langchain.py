...
Provides AgentTraceCallbackHandler that integrates LangChain with AgentTrace
...
class AgentTraceCallbackHandler(BaseCallbackHandler):
    """
    LangChain callback handler that creates AgentTrace Steps.

    This handler implements the LangChain callback protocol to capture
    chain, LLM, tool, and retriever events as AgentTrace Steps.
