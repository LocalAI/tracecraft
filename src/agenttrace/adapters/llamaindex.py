...
Provides AgentTraceSpanHandler that integrates LlamaIndex with AgentTrace
...
class AgentTraceSpanHandler(BaseSpanHandler):
    """
    LlamaIndex span handler that creates AgentTrace Steps.

    This handler implements the LlamaIndex instrumentor/span handler protocol
    to capture spans from LlamaIndex operations as AgentTrace Steps.
    ...
    def start_trace(self, trace_id: str | None = None) -> None:
        ...
        This is a no-op for AgentTrace since we use the span-based tracing.
...
class AgentTraceLlamaIndexCallback(BaseCallbackHandler):
    """
    ...
    events from LlamaIndex operations as AgentTrace Steps.
...
LlamaIndexCallbackHandler = AgentTraceLlamaIndexCallback
