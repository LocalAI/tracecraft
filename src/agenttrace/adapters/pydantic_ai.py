...
Provides AgentTraceSpanProcessor that intercepts OpenTelemetry spans
from PydanticAI/Logfire and creates AgentTrace Steps.
"""
...
class AgentTraceSpanProcessor(SpanProcessor):
    """
    OTel SpanProcessor that creates AgentTrace Steps from spans.
    ...
    AgentTrace Steps with OpenInference attributes.
