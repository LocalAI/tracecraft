"""
Dataset conversion utilities for AgentTrace.

Convert between AgentTrace traces and common dataset formats.
"""
...
def traces_to_csv(
    ...
    Example:
        from agenttrace.datasets import traces_to_csv
...
def traces_to_huggingface(
    ...
    Example:
        from agenttrace.datasets import traces_to_huggingface

        dataset = traces_to_huggingface("traces/agenttrace.jsonl")
...
def traces_to_jsonl(
    ...
    Example:
        from agenttrace.datasets import traces_to_jsonl
...
def create_golden_dataset(
    ...
    Example:
        from agenttrace.datasets import create_golden_dataset
...
def create_finetuning_dataset(
    ...
    Example:
        from agenttrace.datasets import create_finetuning_dataset
