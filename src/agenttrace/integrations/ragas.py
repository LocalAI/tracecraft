"""
RAGAS integration for AgentTrace.

Converts AgentTrace traces to RAGAS evaluation datasets for RAG evaluation.
...
def traces_to_ragas_dataset(
    ...
    """
    Convert AgentTrace traces to a RAGAS evaluation dataset.
    ...
    Example:
        from agenttrace.integrations.ragas import traces_to_ragas_dataset
        from ragas import evaluate
        from ragas.metrics import faithfulness, context_precision

        dataset = traces_to_ragas_dataset("traces/agenttrace.jsonl")
...
def evaluate_rag_traces(
    ...
    **kwargs: Any,
    ...
    Example:
        ...
        results = evaluate_rag_traces("traces/agenttrace.jsonl")
