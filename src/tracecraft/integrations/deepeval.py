"""
DeepEval integration for TraceCraft.

Converts TraceCraft traces to DeepEval test cases for evaluation.
...
def traces_to_test_cases(
    ...
    """
    Convert TraceCraft traces to DeepEval LLMTestCase objects.
    ...
    Example:
        from tracecraft.integrations.deepeval import traces_to_test_cases
...
def evaluate_traces(
    ...
    **kwargs: Any,
    ...
    Example:
        from tracecraft.integrations.deepeval import evaluate_traces
