"""
Langfuse prompt provider for TraceCraft.

Allows fetching prompts from Langfuse while using TraceCraft for tracing.
...
class LangfusePromptProvider:
    """
    Fetch prompts from Langfuse for use with TraceCraft tracing.

    This allows you to manage prompts in Langfuse's prompt management UI
    while using TraceCraft for observability and tracing.

    Example:
        from tracecraft.integrations.langfuse_prompts import LangfusePromptProvider
        import tracecraft

        prompts = LangfusePromptProvider()

        @tracecraft.trace_llm(name="chat")
...
def create_tracing_callback(
    ...
    **prompt_kwargs: Any,
    ...
    Useful for adding prompt info to TraceCraft step attributes.
    ...
    Example:
        import tracecraft
        from tracecraft.integrations.langfuse_prompts import (
