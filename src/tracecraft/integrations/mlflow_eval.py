"""
MLflow evaluation bridge for TraceCraft.

Enables using MLflow's genai.evaluate() capabilities on TraceCraft traces.
...
def traces_to_mlflow_dataset(
    ...
    """
    Convert TraceCraft traces to MLflow evaluation dataset.
    ...
    Example:
        from tracecraft.integrations.mlflow_eval import traces_to_mlflow_dataset
        import mlflow

        df = traces_to_mlflow_dataset("traces/tracecraft.jsonl")
...
def evaluate_with_mlflow_judges(
    ...
    **kwargs: Any,
    ...
    Example:
        from tracecraft.integrations.mlflow_eval import evaluate_with_mlflow_judges
...
def evaluate_with_custom_scorer(
    ...
    **kwargs: Any,
    ...
    Example:
        from tracecraft.integrations.mlflow_eval import evaluate_with_custom_scorer
...
def log_traces_to_mlflow(
    ...
    """
    Log TraceCraft traces to MLflow as an artifact.
    ...
    Example:
        from tracecraft.integrations.mlflow_eval import log_traces_to_mlflow
