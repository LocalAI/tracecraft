"""
MLflow evaluation helpers for TraceCraft.

Provides utilities for evaluating LLM agent outputs using MLflow's
evaluation framework, with integration into TraceCraft traces.
"""
...
try:
    ...
    def evaluate_with_mlflow(
        ...
        track_in_tracecraft: bool = True,
        **kwargs: Any,
    ) -> Any:
        """
        Run MLflow evaluation with TraceCraft tracking.

        Wraps mlflow.evaluate() to automatically create TraceCraft
        ...
        Args:
            ...
            track_in_tracecraft: Whether to create TraceCraft steps.
    ...
    def log_evaluation_to_mlflow(
        ...
        """
        Log an TraceCraft evaluation step to MLflow.
        ...
        Example:
            ```python
            from tracecraft.contrib.evaluation import evaluation_step, log_evaluation_to_mlflow
    ...
    def evaluate_with_mlflow(*args: Any, **kwargs: Any) -> Any:  # noqa: ARG001
        ...
        raise ImportError(
            "mlflow required for evaluate_with_mlflow. Install with: pip install tracecraft[mlflow]"
        )
    ...
    def log_evaluation_to_mlflow(*args: Any, **kwargs: Any) -> Any:  # noqa: ARG001
        ...
        raise ImportError(
            ...
            "Install with: pip install tracecraft[mlflow]"
        )
