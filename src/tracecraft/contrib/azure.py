...
def configure_for_ai_foundry(
    ...
    - TRACECRAFT_AZURE_AGENT_NAME: Agent name
    - TRACECRAFT_AZURE_AGENT_ID: Agent ID
    ...
    if enable_content_recording is None:
        env_value = os.environ.get("TRACECRAFT_AZURE_CONTENT_RECORDING", "false")
...
class AzureAITracerAdapter:
    ...
    Allows using TraceCraft as a drop-in replacement or alongside
    ...
    Note:
        This adapter wraps TraceCraftCallbackHandler and adds Azure AI Foundry
