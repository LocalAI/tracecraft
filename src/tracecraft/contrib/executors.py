...
(TraceCraft context) to thread pool workers.
"""
...
def copy_context_run(fn: Callable[..., T]) -> Callable[..., T]:
    ...
    Example:
        ...
        from tracecraft.core.context import run_context, get_current_run
...
class TALContextExecutor(ThreadPoolExecutor):
    ...
    calling thread's context, ensuring that TraceCraft's run and step
