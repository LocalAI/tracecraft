...
@dataclass
class TraceContext:
    """Captures the full TraceCraft context for propagation.
...
async def gather_with_context(
    *coros: Coroutine[Any, Any, T],
    ...
    """
    Like asyncio.gather but propagates full TraceCraft context to all coroutines.
...
def create_task_with_context(
    ...
    *,
    ...
    """
    Like asyncio.create_task but propagates full TraceCraft context.
...
async def run_in_executor_with_context(
    ...
    *args: Any,
    ...
    """
    Like loop.run_in_executor but propagates full TraceCraft context to the thread.
