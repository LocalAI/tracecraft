...
import { Card, Cards, Details } from '@/components'
...
For simpler use cases, consider [Auto-Instrumentation](/auto-instrumentation) or [TraceCraft decorators](/user-guide/decorators).
</Callout>
...
<Tabs items={['Basic (Receiver Only)', 'With OpenAI Instrumentation', 'With Multiple SDKs', 'Full Installation']}>
<Tabs.Tab>
```bash
...
<Tabs items={['Before (Manual Setup) - 15 lines', 'After (With TraceCraft) - 3 lines']}>
<Tabs.Tab>
```python
...
<Callout type="warning" title="Install Instrumentation Packages">
...
<Tabs items={['Development (.env)', 'Production (.env)', 'Python Code']}>
<Tabs.Tab>
```bash
...
<Tabs items={['Local TraceCraft', 'DataDog', 'Azure', 'AWS X-Ray']}>
<Tabs.Tab>
```python
...
<Callout type="warning" title="Don't Forget to Flush">
...
<Details summary="Is the receiver running?">
...
<Details summary="Did you flush before exit?">
...
<Details summary="Is the endpoint correct?">
...
<Details summary="Are you setting TraceCraft attributes?">
...
<Details summary="Did you install the instrumentation package?">
...
<Details summary="Did you instrument before importing the SDK?">
...
<Details summary="Are you instrumenting multiple times?">
