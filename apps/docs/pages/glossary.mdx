...
See also: [Integrations](/integrations/index), [Step](#step)
...
See also: [Auto-Instrumentation Guide](/integrations/auto-instrumentation)
...
See also: [Decorators Guide](/user-guide/decorators), [StepType](#steptype)
...
See also: [Exporters Guide](/user-guide/exporters)
...
See also: [OpenTelemetry Receiver](/integrations/otel-receiver), [TUI](#tui)
...
See also: [Processors Guide](/user-guide/processors), [PII Redaction](#pii-redaction), [Sampling](#sampling)
...
See also: [Configuration Guide](/user-guide/configuration), [TraceCraftRuntime](#tracecraftruntime)
...
See also: [TraceCraftConfig](#tracecraftconfig), [Multi-Tenancy](/user-guide/multi-tenancy)
...
See also: [Terminal UI Guide](/user-guide/tui), [OTLPReceiverServer](#otlpreceiverserver)
...
See also: [SimpleSpanProcessor](#simplespanprocessor), [OpenTelemetry Receiver](/integrations/otel-receiver)
...
See also: [Exporters Guide](/user-guide/exporters), [OTLPReceiverServer](#otlpreceiverserver)
...
See also: [StepType](#steptype), `@trace_retrieval` in [Decorators Guide](/user-guide/decorators)
...
- [Core Concepts](/getting-started/concepts) - Conceptual overview of how TraceCraft works
- [API Reference](/api/index) - Full API documentation
- [User Guide](/user-guide/index) - Feature documentation and how-to guides
